...
void BasePhyLayer::initialize(int stage) {
    ...
    if (stage == 0) {
        ...
        //********add in the 5-25********//
        decider->mubusytimemin_1=0;
        decider->mubusytimemax_5=0;

        statechangemin_1 =new cMessage("statechangemin");
        t_statechangemin_1 =1;
        scheduleAt(simTime()+t_statechangemin_1,statechangemin_1);

        statechangemax_5 =new cMessage("statechangemax");
        t_statechangemax_5 =5;
        scheduleAt(simTime()+t_statechangemax_5,statechangemax_5);

        busytimeVec.setName("busytimeState");
...
void BasePhyLayer::handleMessage(cMessage* msg) {
    ...
    if(msg->isSelfMessage()) {
        ...
        //********add in the 5-25********//
        if(msg == statechangemax_5)
        {
            scheduleAt(simTime() + t_statechangemax_5, statechangemax_5);
            CBRmax_5 =decider->mubusytimemax_5 / 5;
            decider->mubusytimemax_5 =0;
        }
        else if(msg == statechangemin_1)
        {
            scheduleAt(simTime() + t_statechangemin_1, statechangemin_1);
            CBRmin_1 =decider->mubusytimemin_1;
            busytimeVec.recordWithTimestamp(simTime(),decider->mubusytimemin_1);
        }
        //*************************************//
